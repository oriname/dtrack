...
with DAG(
    ...
    process_records = PythonOperator(
        ...
        #trigger_rule='all_done',  # This will run the task even if the sensor is skipped
        trigger_rule='all_success', #If sensor is skipped, operator will be skipped
    )

    wait_until_allowed_time >> check_new_records >> process_records